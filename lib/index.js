...
class FortnoxClient {
    ...
    async getCustomers(page, offset, search, sortorder = 'ascending') {
        const url = util.generateUrl(this.url + '/customers', { page, offset, sortorder, search })
        try {
    ...
    async getArticles(page, offset, search, sortorder = 'ascending') {
        try {
            const url = util.generateUrl(this.url + '/articles', { page, offset, sortorder, search })
            const res = await fetch(url, {
                headers: this.headers
            })
            return res.json();
    ...
    async getOrders(page, offset, search, sortorder = 'ascending') {
        try {
            const url = util.generateUrl(this.url + '/orders', { page, offset, sortorder, search })
            const res = await fetch(url, {
                headers: this.headers
            })
            return res.json();
    ...
    async getPriceLists(page, offset, search, sortorder = 'ascending') {
        try {
            const url = util.generateUrl(this.url + '/pricelists', { page, offset, sortorder, search })
            const res = await fetch(url, {
                headers: this.headers
            })
            return res.json();
